...
CROP_PROFILES = {
    'maize': {
        'label': 'Maize / Corn', 'water_demand_l_day': 5.5,
        'stress_temp_high': 32, 'stress_moisture_low': 35,
        'root_depth_factor': 0.9,
        'season_adjust': {'long_rains': 0.4, 'cool_dry': 0.85, 'short_rains': 0.5, 'hot_dry': 1.3, 'transition': 1.0},
    },
    'tomato': {
        'label': 'Tomato', 'water_demand_l_day': 6.0,
        'stress_temp_high': 30, 'stress_moisture_low': 40,
        'root_depth_factor': 0.85,
        'season_adjust': {'long_rains': 0.45, 'cool_dry': 0.9, 'short_rains': 0.55, 'hot_dry': 1.4, 'transition': 1.0},
    },
    'rice': {
        'label': 'Rice', 'water_demand_l_day': 8.0,
        'stress_temp_high': 35, 'stress_moisture_low': 55,
        'root_depth_factor': 1.1,
        'season_adjust': {'long_rains': 0.3, 'cool_dry': 1.0, 'short_rains': 0.35, 'hot_dry': 1.5, 'transition': 1.0},
    },
    'beans': {
        'label': 'Beans', 'water_demand_l_day': 4.5,
        'stress_temp_high': 30, 'stress_moisture_low': 35,
        'root_depth_factor': 0.95,
        'season_adjust': {'long_rains': 0.4, 'cool_dry': 0.8, 'short_rains': 0.45, 'hot_dry': 1.2, 'transition': 1.0},
    },
    'potato': {
        'label': 'Potato', 'water_demand_l_day': 5.0,
        'stress_temp_high': 28, 'stress_moisture_low': 40,
        'root_depth_factor': 0.9,
        'season_adjust': {'long_rains': 0.5, 'cool_dry': 0.75, 'short_rains': 0.55, 'hot_dry': 1.25, 'transition': 1.0},
    },
    'wheat': {
        'label': 'Wheat', 'water_demand_l_day': 4.0,
        'stress_temp_high': 30, 'stress_moisture_low': 30,
        'root_depth_factor': 1.0,
        'season_adjust': {'long_rains': 0.45, 'cool_dry': 0.7, 'short_rains': 0.5, 'hot_dry': 1.2, 'transition': 1.0},
    },
    'cabbage': {
        'label': 'Cabbage', 'water_demand_l_day': 4.0,
        'stress_temp_high': 28, 'stress_moisture_low': 40,
        'root_depth_factor': 0.85,
        'season_adjust': {'long_rains': 0.5, 'cool_dry': 0.8, 'short_rains': 0.55, 'hot_dry': 1.2, 'transition': 1.0},
    },
    'onion': {
        'label': 'Onion', 'water_demand_l_day': 3.5,
        'stress_temp_high': 30, 'stress_moisture_low': 35,
        'root_depth_factor': 0.8,
        'season_adjust': {'long_rains': 0.5, 'cool_dry': 0.85, 'short_rains': 0.55, 'hot_dry': 1.15, 'transition': 1.0},
    },
    'carrot': {
        'label': 'Carrot', 'water_demand_l_day': 3.5,
        'stress_temp_high': 28, 'stress_moisture_low': 35,
        'root_depth_factor': 1.0,
        'season_adjust': {'long_rains': 0.5, 'cool_dry': 0.8, 'short_rains': 0.55, 'hot_dry': 1.15, 'transition': 1.0},
    },
    'lettuce': {
        'label': 'Lettuce', 'water_demand_l_day': 3.0,
        'stress_temp_high': 26, 'stress_moisture_low': 45,
        'root_depth_factor': 0.75,
        'season_adjust': {'long_rains': 0.45, 'cool_dry': 0.85, 'short_rains': 0.5, 'hot_dry': 1.3, 'transition': 1.0},
    },
    'general': {
        'label': 'General Crop', 'water_demand_l_day': 4.0,
        'stress_temp_high': 32, 'stress_moisture_low': 35,
        'root_depth_factor': 1.0,
        'season_adjust': {'long_rains': 0.5, 'cool_dry': 0.8, 'short_rains': 0.55, 'hot_dry': 1.2, 'transition': 1.0},
    },
